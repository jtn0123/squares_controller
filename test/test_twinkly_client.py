"""Tests for TwinklyClient behaviour: status, baking, and streaming.

The pure protocol transforms these build on are covered separately in
test_twinkly_protocol.py; everything here exercises a client instance —
its state, its locking, and the requests it makes.
"""
