...
import { loadPreset, sceneForId } from "./scenes.js";
import { loadLibrary } from "./library_sync.js";
import { advancePlaylist } from "./library_model.js";

export function populatePlaylistSceneSelect() {
  const select = $("#playlistSceneSelect");
...
export function renderPlaylistDraft() {
...
export function initializePlaylists() {
  $("#addPlaylistStepButton").addEventListener("click", () => {
    const sceneId = $("#playlistSceneSelect").value;
    const duration = Number($("#playlistDuration").value);
